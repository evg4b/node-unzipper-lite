...
var { promiseProps, mapSeries, promiseMap } = require('../helpres');
...
module.exports = function centralDirectory(source, options) {
  ...
  return source.size()
    ...
    .then(function() {
      return promiseProps({directory: endDir.pull(22), crxHeader: crxHeader});
    })
    .then(function(d) {
    ...
    .then(function() {
      ...
      vars.extract = function(opts) {
        ...
        return vars.files.then(function(files) {
          return promiseMap(files, function(entry) {
      ...
      vars.files = mapSeries(Array(vars.numberOfRecords),function() {
